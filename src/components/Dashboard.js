...
const Dashboard = () => {
  ...
  // cardStyle replaced by CSS class .stat-card defined in App.css
  // kept for backwards compatibility if necessary
  const cardStyle = {};
          ...
          {transactions.length === 0 ? (
            ...
            <>
              <Row gutter={16}>
                ...
                <Card bordered={true} className="stat-card small-card">
